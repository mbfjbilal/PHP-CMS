  ...
  <div class="row-fluid">
         ...
         <div class="span8" id="divMain">  
            ...
            if (isset($_SESSION['user_role']) && $_SESSION['user_role']== 'admin') {
                ...
                $post_query_count = "SELECT * FROM posts WHERE post_tags LIKE '%$search%'";                
               
            }else {

            $post_query_count = "SELECT * FROM posts WHERE post_tags LIKE '%$search%' && post_status = 'published' ";
     ...
     // }
        ...
        <?php
            ...
            <ul>
                ...
                if ($i == $page) {
                    echo "<li '><a class='number current' href='search.php?search=$search&page={$i}'>{$i}</a></li>";
                } else {
