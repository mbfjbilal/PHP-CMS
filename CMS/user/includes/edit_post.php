	...
	echo "<p class='bg-success'>Post Successfully Updated and Submitted for approval </p>";
...
<form action="" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input value="<?php echo $post_user; ?>" type="text" class="form-control" name="post_user" readonly>
	</div>
	<!-- <div class="form-group">
